    ...
    <aside class="w-64 min-h-screen bg-white border-r border-slate-200 flex flex-col fixed top-0 left-0 z-20 shadow-sm" id="sidebar">
        ...
        <div class="border-t border-slate-100 p-4">
            <div class="flex items-center gap-3">
                <div class="w-9 h-9 rounded-full bg-brand-900 flex items-center justify-center text-white font-bold">

                    @php
                    $initial = trim($__env->yieldContent('user-initial', 'U'));
                    @endphp

                    {{ strtoupper(substr($initial, 0, 1)) }}
